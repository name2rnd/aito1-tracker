...
type AgentTaskResponse struct {
	...
	BindingGeneration       *int32                `json:"binding_generation,omitempty"`
...
func taskToResponse(t db.AgentTaskQueue) AgentTaskResponse {
	...
	var bindingGeneration *int32
	if t.BindingGeneration.Valid {
		value := t.BindingGeneration.Int32
	...
	return AgentTaskResponse{
		...
		EffectID:          textToPtr(t.EffectID),
		BindingGeneration: bindingGeneration,
		AgentRole:         textToPtr(t.AgentRole),
